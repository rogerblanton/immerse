...
%><%@ page import="java.util.ResourceBundle,
    ...
    String name = xssAPI.encodeForHTMLAttr(FormsHelper.getParameterName(resource));
    String id = xssAPI.encodeForHTMLAttr(FormsHelper.getFieldId(slingRequest, resource));
    String cssClass = xssAPI.encodeForHTMLAttr(FormsHelper.getCss(properties, "form_field form_field_file"));
...
%>
        <div class="form_rightcol"><input id="<%=id%>" class="<%=cssClass%>" name="<%=name%>" type="file" size="28"></div>
<%
    }
%>
    </div><%
