...
%><cq:defineObjects/><%
    ...
    String language = currentPage != null ? currentPage.getLanguage(false).toLanguageTag() : null;
...
<html <%= wcmModeIsPreview ? "class=\"preview\"" : ""%> lang="<%= xssAPI.encodeForHTMLAttr(language) %>">
