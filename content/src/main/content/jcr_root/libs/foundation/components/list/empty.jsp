...
--%><%@ page session="false" import="com.day.cq.wcm.api.WCMMode, com.day.cq.wcm.foundation.Placeholder"%><%
%><%@include file="/libs/foundation/global.jsp"%><%

if (Placeholder.isAuthoringUIModeTouch(slingRequest) || WCMMode.fromRequest(slingRequest) == WCMMode.EDIT){
