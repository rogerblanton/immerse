...
%><li<%=request.getAttribute("listitemclass")%>>
    <p>
        <a href="<%= xssAPI.getValidHref(listItem.getPath()) %>.html" title="<%= StringEscapeUtils.escapeHtml4(listItem.getTitle()) %>"><%= StringEscapeUtils.escapeHtml4(listItem.getTitle()) %></a>
    </p>
</li>